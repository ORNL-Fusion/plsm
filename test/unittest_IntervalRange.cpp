...
TEMPLATE_LIST_TEST_CASE(
	"IntervalRange Basic", "[IntervalRange][template]", test::IntTypes)
{
...
TEMPLATE_LIST_TEST_CASE(
	"IntervalRange Range-for", "[IntervalRange][template]", test::IntTypes)
{
...
TEMPLATE_LIST_TEST_CASE(
	"IntervalRange constexpr", "[IntervalRange][template]", test::IntTypes)
{
