...
TEMPLATE_LIST_TEST_CASE(
	"SpaceVector 2D", "[SpaceVector][template]", test::ScalarTypes)
{
...
TEMPLATE_LIST_TEST_CASE(
	"SpaceVector 3D", "[SpaceVector][template]", test::ScalarTypes)
{
...
TEMPLATE_LIST_TEST_CASE(
	"SpaceVector Filled", "[SpaceVector][template]", test::ScalarTypes)
{
...
TEMPLATE_LIST_TEST_CASE(
	"SpaceVector Axis", "[SpaceVector][template]", test::IntTypes)
{
	SECTION("2D")
	{
