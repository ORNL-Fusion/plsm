...
public:
	...
	public:
		...
		constexpr Iterator(LimitType value) noexcept : _value{value}
		{
		}
	 ...
	 */
	KOKKOS_INLINE_FUNCTION
	constexpr IntervalRange() noexcept : _ival{}
	{
	}
	 ...
	 */
	explicit KOKKOS_INLINE_FUNCTION
	constexpr IntervalRange(LimitType end) noexcept : _ival{end}
	{
	}
	 ...
	 */
	KOKKOS_INLINE_FUNCTION
	constexpr IntervalRange(LimitType begin, LimitType end) noexcept :
		_ival{begin, end}
	{
	}
	 ...
	 */
	KOKKOS_INLINE_FUNCTION
	constexpr IntervalRange(const Interval<LimitType>& ival) noexcept :
		_ival{ival}
	{
	}
...
constexpr bool
operator==(
	const IntervalRange<TLimit>& a, const IntervalRange<TLimit>& b) noexcept
{
